...
const MatchDetail = ({ setHoveredFlightCoords }) => {
  ...
  const handleMouseEnter = (haves) => {
    const coords = {
      ...
      toLat: haves.toLat,
      toLong: haves.toLong,
      fromCity: haves.fromCity || 'Unknown Departure', // Include fromCity
      toCity: haves.toCity || 'Unknown Destination',   // Include toCity
    };
  ...
  if (!selectedCompanyDetails || selectedCompanyDetails.length === 0) {
    return (
      <PageContainer>
        <div className="text-center py-4 text-sm">No matching companies found</div>
      </PageContainer>
    );
  }
    ...
    <PageContainer>
      <div>
        <div className="flex justify-between items-center mb-8 border-b border-gray-100 pb-4">
          <h1 className="font-bold text-2xl text-gray-800">Matching Companies</h1>
