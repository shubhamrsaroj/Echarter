...
const DateAdjustmentDetails = ({ company, parentSortDirection, parentFilters, setHoveredFlightCoords }) => {
  ...
  // Don't hide companies with no filtered results - we'll show an empty table with message
...
DateAdjustmentDetails.propTypes = {
...
export default DateAdjustmentDetails;
