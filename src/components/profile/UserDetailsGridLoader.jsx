      ...
      <div className="flex flex-col md:flex-row w-full gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-grow">
                {[1, 2, 3].map((item) => (
                  <div key={item} className="flex items-start">
                    <div className="mr-2 w-5 h-5 bg-gray-300 rounded-full flex-shrink-0"></div>
                    <div className="space-y-2 min-w-0 flex-grow">
                      <div className="h-4 bg-gray-300 rounded w-24"></div>
                      <div className="h-5 bg-gray-300 rounded w-full md:w-36"></div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm w-full animate-pulse">
            ...
            <div className="p-5 space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="h-5 bg-gray-300 rounded w-full md:w-2/3"></div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 h-full">
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm w-full animate-pulse">
            ...
            <div className="p-5 space-y-3">
              <div className="h-7 bg-gray-300 rounded w-full md:w-1/3"></div>
              <div className="h-5 bg-gray-300 rounded w-full md:w-2/3"></div>
              <div className="h-5 bg-gray-300 rounded w-full md:w-1/2"></div>
